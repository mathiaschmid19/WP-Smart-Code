...
<div class="wrap ecs-snippets-page">
	...
	<div class="ecs-page-header">
		<div class="ecs-header-content">
			...
			<div class="ecs-header-actions">
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets-tools' ) ); ?>" class="button button-secondary button-large">
					<span class="dashicons dashicons-admin-tools"></span>
					<?php esc_html_e( 'Tools', 'edge-code-snippets' ); ?>
				</a>
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets-editor' ) ); ?>" class="button button-primary button-large">
	...
	<div class="ecs-type-tabs">
		<div class="ecs-type-tabs-wrapper">
			...
			?>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets' ) ); ?>" 
			   class="ecs-type-tab <?php echo empty( $current_type ) ? 'active' : ''; ?>">
				<?php esc_html_e( 'All Snippets', 'edge-code-snippets' ); ?>
			</a>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets&type=php' ) ); ?>" 
			   class="ecs-type-tab <?php echo 'php' === $current_type ? 'active' : ''; ?>">
				<?php esc_html_e( 'PHP', 'edge-code-snippets' ); ?>
			</a>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets&type=js' ) ); ?>" 
			   class="ecs-type-tab <?php echo 'js' === $current_type ? 'active' : ''; ?>">
				<?php esc_html_e( 'JavaScript', 'edge-code-snippets' ); ?>
			</a>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets&type=css' ) ); ?>" 
			   class="ecs-type-tab <?php echo 'css' === $current_type ? 'active' : ''; ?>">
				<?php esc_html_e( 'CSS', 'edge-code-snippets' ); ?>
			</a>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=edge-code-snippets&type=html' ) ); ?>" 
			   class="ecs-type-tab <?php echo 'html' === $current_type ? 'active' : ''; ?>">
				<?php esc_html_e( 'HTML', 'edge-code-snippets' ); ?>
			</a>
		</div>
	</div>
	...
	<form method="get">
		<input type="hidden" name="page" value="edge-code-snippets">
		<?php
		if ( isset( $list_table ) && is_object( $list_table ) ) {
			$list_table->views();
			$list_table->search_box( __( 'Search Snippets', 'edge-code-snippets' ), 'snippet' );
			$list_table->display();
		}
		?>
	</form>
